...
// Добавление картинки (схемы подъемника) на холст
  var pic = new Image();
  pic.src = 'img/GP-GH-1000-2-priymok-noProh.jpg';
...
// Высота подъема
  ...
  function vFunk() {
    ...
    ctx.fillStyle = 'white';
    ctx.fillRect(x + 5, y, 40, 120); //очистим от предыдущего размера (40, 120 - вертикальное стирание)
    getRotate(x + 10, y + 90, vText.value);
    // makeGap(); //вызов функции монтажных зазоров
  }
...
// Высота приямка
  ...
  function prFunk() {
    ...
    ctx.fillStyle = 'white';
    ctx.fillRect(x, y, 35, -90); //очистим от предыдущего размера (40, 120 - вертикальное стирание)
...
function shuhtWidthFunk() {
  ...
  ctx.fillStyle = 'white';
  ctx.fillRect(x + 5, y - 10, 150, 40); //очистим от предыдущего размера (120, 40 - горизонтальное стирание)
...
// Глубина кабины
  ...
  // Высота кабины
    ...
    function cabHeightFunk() {
      ...
      else if(gruzPod === 2000 && vText.value < 24000) {tal = 402} //тельфер на 3200кг
