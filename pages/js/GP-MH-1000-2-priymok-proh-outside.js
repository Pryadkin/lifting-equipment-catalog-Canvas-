...
// Добавление картинки (схемы подъемника) на холст
  var pic = new Image();
  pic.src = 'img/GP-MH-1000-2-priymok-proh-outside.jpg';
...
let makeGap = function() {
  ...
  getNum(x + 20, y + 40, gap()); // Рисуем нижние монтажные зазоры
...
// КПУ
let kpu = function() {
  let x1 = 300; // Координаты нижнего КПУ
      y1 = 950;
      x2 = 630; // Координаты верхнего КПУ
      y2 = 400;
      a = 30; // ширина КПУ
      b = 60; // высота КПУ
